<div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow  sm:px-6 md:px-8 lg:px-10">
    ...
    <div class="mt-8">
        <form action="{{ route('authenticate') }}" autoComplete="off" method="POST">
            @csrf
            <div class="flex flex-col mb-2">
                <div class="flex relative ">
                    ...
                    <input type="text" name="email" id="sign-in-email" class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Your email"/>
                    </div>
                </div>
