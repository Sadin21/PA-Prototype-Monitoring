...
@section('content')
  ...
  <section class="pt-14 mb-20">
    <section class="h-screen">
        <form action="{{ route('admin.update_pengajuan', $data->id) }}" method="POST" class="container bg-white w-full mx-auto md:w-3/4 grid grid-cols-2 p-8 gap-8"  enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div class="">
                ...
                <button type="submit" class="py-2 w-24 bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg mt-11">
                    Submit
                </button>
            </div>
        </form>
