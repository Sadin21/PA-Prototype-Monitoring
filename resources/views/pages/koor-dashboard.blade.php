      ...
      <div>
        <div class="p-4 bg-white shadow-lg rounded-2xl">
          ...
          <div class="flex items-center justify-between gap-4 mt-6">
              <a href="{{ route('koor.detail', $d->id) }}" type="button" class="w-1/2 px-4 py-2 text-base bg-white border rounded-lg text-grey-500 hover:bg-gray-200 ">
                  Detail
              </a>
